      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-[2.5rem] mesh-bg noise px-6 py-16 text-center shadow-card sm:px-16 sm:py-20">
          ...
          <div className="relative z-10 mx-auto max-w-2xl">
            <span className="eyebrow border-white/20 bg-white/10 text-white">Geleceğe İlk Adım</span>
            ...
            <p className="mt-5 text-base leading-relaxed text-white/75 sm:text-lg">
              Ücretsiz seviye belirleme ve tanışma görüşmesi için hemen randevu oluşturun. Size en
              uygun kurumumuzu birlikte belirleyelim.
            </p>
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link to="/iletisim" className="btn border border-white/25 text-white hover:bg-white/10">
                İletişim Formu <Icon name="arrow" className="h-4 w-4" />
              </Link>
            </div>
          </div>
        </div>
